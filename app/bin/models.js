...
(function() {
  var Checkbox, Description, Field, Group, Multiple, Text,
  ...
  Description = (function(_super) {
    __extends(Description, _super);

    Description.prototype.type = "description";

    function Description(data, group) {
      this.toJSON = __bind(this.toJSON, this);      Description.__super__.constructor.call(this, data, group);
      this.info = ko.observable(this.data.attr.info);
    }
